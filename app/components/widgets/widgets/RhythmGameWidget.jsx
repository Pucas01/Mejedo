...
export default function RhythmGameWidget({ widgetId }) {
  ...
  }, [gameState, selectedSong, chartData, NOTE_SPEED_PER_MS]);
  ...
  useEffect(() => {
    ...
    const handleEscape = (e) => {
      if (e.key === "Escape") {
        // In widget, don't close on escape in menu
        e.preventDefault();
      }
    };
  ...
  return (
    <div className="flex flex-col h-full gap-2">
      ...
      >
        ...
        {feedback && (
          <div
            className="absolute left-1/2 -translate-x-1/2 font-bold animate-rhythm-feedback"
            style={{
              top: HIT_ZONE_Y + 50,
      ...
      <div className="text-center text-gray-500 text-xs bg-[#1a1a1f] border border-[#39ff14]/30 p-2">
        ...
        <span className="text-[#f9393f]"> K</span>
